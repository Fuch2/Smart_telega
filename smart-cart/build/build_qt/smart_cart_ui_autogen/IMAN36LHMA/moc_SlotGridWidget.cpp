...
namespace {
struct qt_meta_stringdata_SlotGridWidget_t {
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_SlotGridWidget_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_SlotGridWidget_t qt_meta_stringdata_SlotGridWidget = {
    {
        QT_MOC_LITERAL(0, 14),  // "SlotGridWidget"
        QT_MOC_LITERAL(15, 11),  // "slotClicked"
        QT_MOC_LITERAL(27, 0),  // ""
        QT_MOC_LITERAL(28, 9),  // "slotIndex"
        QT_MOC_LITERAL(38, 15),  // "setSlotOccupied"
        QT_MOC_LITERAL(54, 8),  // "occupied"
        QT_MOC_LITERAL(63, 13)   // "setTargetSlot"
    },
    "SlotGridWidget",
    "slotClicked",
    "",
...
Q_CONSTINIT static const uint qt_meta_data_SlotGridWidget[] = {
...
Q_CONSTINIT const QMetaObject SlotGridWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_SlotGridWidget.offsetsAndSizes,
    qt_meta_data_SlotGridWidget,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_SlotGridWidget_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<SlotGridWidget, std::true_type>,
        // method 'slotClicked'
...
void SlotGridWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (SlotGridWidget::*)(int );
            if (_t _q_method = &SlotGridWidget::slotClicked; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *SlotGridWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SlotGridWidget.stringdata0))
